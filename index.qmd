...
.news-card {
  ...
  background:
    linear-gradient(
      ...
      rgba(247,248,250,0.92) 38%,
      rgba(238,242,247,0.55) 68%,
      rgba(244,246,249,0.3) 100%
    ),
...
::: news-body
My paper examining the direct and indirect effects of UN peacekeepers' security activities on local support and conflict dynamics is now published open access in *Global Studies Quarterly*.
:::

::: news-meta
[Read the paper ↗](https://doi.org/10.1093/isagsq/ksag120){target="_blank"} · *Global Studies Quarterly*, Vol. 6, Issue 3 · Published 25 August 2026
